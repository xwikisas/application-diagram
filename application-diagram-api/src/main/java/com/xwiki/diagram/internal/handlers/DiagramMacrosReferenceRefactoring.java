...
@Component(roles = DiagramMacrosReferenceRefactoring.class)
@Singleton
public class DiagramMacrosReferenceRefactoring
{
    @Inject
        ...
        String referenceFieldName)
    {
        try {
            ...
            for (Block macroBlock : macroBlocks) {
                boolean addDefaultValue = (macroBlock.getParameter(referenceFieldName) == null);
                String referenceName = addDefaultValue ? "Diagram" : macroBlock.getParameter(referenceFieldName);
                ...
                if (!diagramAlreadyExists) {
                    ...
                    if (!isValid || addDefaultValue) {
                        ...
                        macroBlock.setParameter(referenceFieldName, transformedName);
                        modified = true;
                    }
                    ...
                    macroBlock.setParameter(referenceFieldName, referenceName);
                    modified = true;
                }
            }
            if (modified) {
